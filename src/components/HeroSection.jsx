        ...
        <div className="container max-w-4xl mx-auto text-center z-10">
            <div className="space-y-6">
                <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
                    ...
                    <span className="text-primary opacity-0 animate-fade-in-delay-1"> Praduman</span>
                    <span className="text-gradient ml-2 opacity-0 animate-fade-in-delay-2">Sharma</span>
                </h1>
                
                <h2 className="mt-4 text-lg md:text-2xl font-medium tracking-wide text-glow opacity-0 animate-fade-in-delay-3">
